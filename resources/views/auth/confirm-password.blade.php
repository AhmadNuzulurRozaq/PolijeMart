...
<div class="mb-8 text-center lg:text-left">
    <h1 class="text-3xl font-black text-slate-900 tracking-tight bg-gradient-to-r from-primary-950 to-primary-750 bg-clip-text text-transparent uppercase">Konfirmasi Akses</h1>
    <p class="text-sm text-slate-450 mt-2.5 font-semibold leading-relaxed">Ini adalah area aman aplikasi. Harap konfirmasi kata sandi Anda sebelum melanjutkan.</p>
</div>
...
<form method="POST" action="{{ route('password.confirm') }}" class="space-y-5">
    ...
    <div class="flex flex-col gap-1">
        <label for="password" class="text-xs font-black text-slate-700 uppercase tracking-wider pl-1.5">Kata Sandi Anda</label>
        <div class="relative">
