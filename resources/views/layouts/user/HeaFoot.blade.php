            ...
            <div class="flex items-center justify-between h-16 sm:h-20">
                ...
                <div class="flex-1 max-w-xl mx-4 lg:mx-8 hidden md:block">
                    <div class="relative group">
                        ...
                        <button class="absolute right-3 top-1/2 -translate-y-1/2 text-white group-focus-within:text-[#069BC0] transition-colors p-1">
                ...
                <div class="flex items-center gap-2 sm:gap-4">
                    ...
                    <!-- Cart Icon -->
                    <a href="#" class="relative p-2 text-white hover:bg-white/10 rounded-full transition-colors">
                        ...
                        <span class="absolute top-0 right-0 bg-orange-500 text-white text-[10px] font-bold w-4 h-4 flex items-center justify-center rounded-full border-2 border-[#069BC0]">0</span>
                    </a>

                    <!-- Profile Dropdown -->
                    <div class="relative ml-1 sm:ml-2">
                        <button type="button" id="userMenuBtn" class="flex items-center focus:outline-none p-1 rounded-full border-2 border-transparent hover:border-white/50 transition-all">
                        ...
                        <div id="userDropdown" class="hidden absolute right-0 mt-3 w-56 bg-white rounded-2xl shadow-xl border border-slate-100 py-2 transition-all duration-300 opacity-0 scale-95 origin-top-right z-50">
                            ...
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button type="submit" class="w-full flex items-center gap-3 px-4 py-2.5 text-sm font-bold text-red-600 hover:bg-red-50 transition-colors text-left">
